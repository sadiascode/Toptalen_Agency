            ...
            child: Padding(
             padding: const EdgeInsets.only(left: 20, right: 15),
              ...
              CustomAlert(
                  ...
                  categoryLabel: "underperformance",categoryLabelCo:Color(0xffD4183D),
                  name: 'Sarah Johnson',
              ...
              SizedBox(height:15),
              CustomAlert( priorityLabel: "High",
                  priorityConColor:Color(0xffD4183D),
                  priorityColor: Color(0xffFFE2E2),
                  categoryLabel: "spike",
                  categoryLabelCo:Color(0xffD4183D),name: 'Lisa Anderson',
              ...
              SizedBox(height:15),
              CustomAlert( priorityLabel: "Medium",
                priorityConColor:Color(0xffFF6900),
                priorityColor: Color(0xffFFEDD4),
                categoryLabel: "target",
                categoryLabelCo:Color(0xffFF6900),name: 'Sarah Johnson',
              ...
              CustomAlert(
                ...
                categoryLabelCo:Color(0xffFF6900),name: 'Lisa Anderson',
